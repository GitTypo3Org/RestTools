...
class DataCollector(object):
    ...
    def __init__(self, parent=None, taginfo=0):
        self.parent = parent
...
class MyHTMLParser(HTMLParser.HTMLParser):
    ...
    def __init__(self, tagwriter=None, taginfo=0):
        ...
        self.taglevel = 0
        self.tagstack = []
        self.datacollector = DataCollector(parent=self, taginfo=taginfo)
...
def main(f1name, f2name, f3name=None, f4name=None, appendlog=0, taginfo=0):
    ...
    P = MyHTMLParser(tagwriter=f3, taginfo=taginfo)
...
if __name__=="__main__":
    ...
    main(args.infile, args.outfile, args.treefile, args.logfile, args.appendlog, args.taginfo)
